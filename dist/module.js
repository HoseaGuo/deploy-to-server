        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    // TODO: 文件删除排除 可以配置
                    return [4 /*yield*/, ssh.execCommand("rm `find ./* |egrep -v 'node_modules'` -rf", { cwd: customOptions.serverPath })];
                case 3:
                    // 删除除了node_modules外的文件
                    // TODO: 文件删除排除 可以配置
                    _a.sent();
...
function loadingLog(str) {
    ...
    return function end(isSuccess) {
        ...
        if (isSuccess) {
            ...
            update(chalk.rgb(92, 175, 158)("[\u221A] ".concat(str, " ")) + chalk.whiteBright(formatNs(endTimestamp - startTimestamp)));
        }
        else {
